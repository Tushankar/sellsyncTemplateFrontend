    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <div className="flex-1 pt-20 sm:pt-24 pb-12 sm:pb-16">
        <div className="container px-4 md:px-6 max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-[#1C244B]">Privacy Policy</h1>

            <div className="prose prose-lg prose-blue max-w-none text-gray-600 space-y-8">
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-[#1C244B] mb-4">1. Introduction</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-[#1C244B] mb-4">2. Collection of Information</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-[#1C244B] mb-4">3. Use of Your Information</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-[#1C244B] mb-4">4. Disclosure of Your Information</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-[#1C244B] mb-4">5. Security of Your Information</h2>
                <p>
